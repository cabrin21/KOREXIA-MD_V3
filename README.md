...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=180&section=header&text=KØREXIA-MD&fontSize=72&fontColor=fff&animation=twinkling&fontAlignY=32&desc=High%20Performance%20WhatsApp%20Bot&descAlignY=55&descSize=20" width="100%"/>
...
1. Enter your bot's WhatsApp number with country code (e.g. `50931221850`)
...
```env
SESSION_ID=Nsala/KØREXIA-MD_xxxxxxxxxxxxxxxxxxxxxxxx
```
...
```env
# ── REQUIRED (choose one) ────────────────────────────────────
SESSION_ID=Nsala/KØREXIA-MD_your_gist_id_here
# OR
PAIRING_NUMBER=50931221850

# ── REQUIRED ─────────────────────────────────────────────────
OWNER_NUMBER=509000000000        # No + sign

# ── BOT IDENTITY ─────────────────────────────────────────────
BOT_NAME=KØREXIA-MD-PRO
BOT_OWNER=Nsala
PACKNAME=KØREXIA-MD
...
```bash
# After install:
nano /root/KØREXIA-MD/.env
cd /root/KØREXIA-MD && pm2 start dist/index.js --name mega-md
