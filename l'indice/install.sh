...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "   KØREXIA-MD WhatsApp Bot Installer  "
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
if [ ! -f .env ]; then
  ...
  echo "# DB_URL=" >> .env
  echo ""
  echo "⚠️  Please edit /root/KØREXIA-MD/.env with your settings"
  echo "   nano /root/KØREXIA-MD/.env"
fi
...
echo ""
echo "Next steps:"
echo "  1. Edit your config: nano /root/KØREXIA-MD/.env"
echo "  2. Start the bot:    cd /root/KØREXIA-MD && pm2 start index.js --name mega-md"
